...
sentinel_cfg = AdvanceConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_advanced_proto_version_with_sentinel_ping = 70207


def get_advance_conf():
    home = os.environ.get('HOME')

    advance_conf = os.path.join(home, ".advanceprotocol/advance.conf")
    if sys.platform == 'darwin':
        advance_conf = os.path.join(home, "Library/Application Support/AdvanceProtocol/advance.conf")

    advance_conf = sentinel_cfg.get('advance_conf', advance_conf)
