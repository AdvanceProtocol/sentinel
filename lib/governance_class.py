...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to advanced "gobject list" output
    ...
    def advanced_serialise(self):
        import advancelib
        return advancelib.SHIM_serialise_for_advanced(self.serialise())
